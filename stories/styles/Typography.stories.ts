    ...
    container.innerHTML = `
      ...
      <div style="padding: 20px; background: #fff;">
        ...
        <div style="margin-bottom: 24px;">
          <h4>正文字体 (body)</h4>
          <p style="font-family: ${theme.fonts.body}; font-size: 14px;">
            天津中医药大学第二附属医院 - 国际产后康复中心
          </p>
          <p style="font-family: ${theme.fonts.body}; font-size: 14px;">
            The quick brown fox jumps over the lazy dog. 0123456789
          </p>
          <code style="font-size: 12px; color: #666;">${theme.fonts.body}</code>
        </div>
        
        <div style="margin-bottom: 24px;">
          <h4>标题字体 (heading)</h4>
          <p style="font-family: ${theme.fonts.heading}; font-size: 18px; font-weight: bold;">
            产妇入院评估单
          </p>
          <code style="font-size: 12px; color: #666;">${theme.fonts.heading}</code>
        </div>
...
export const ChineseTypography: Story = {
  ...
  render: () => {
    ...
    container.innerHTML = `
      <style>${css}</style>
      <div style="padding: 20px; background: #fff; font-family: ${theme.fonts.body};">
        <h3 style="margin-top: 0; font-family: ${theme.fonts.heading};">中文排版示例</h3>
